...
", @"No ReqIF initial import for an Roundtrip available, break!");
        ...
        public bool ExportRequirements(int subModuleIndex = 0)
        {
            ...
            _reqIf = WriteHeader(ImportModuleFile, subModuleIndex==0);
        ...
        /// <summary>
        /// Read the current ReqIF header or create a new one
        /// </summary>
        /// <param name="file"></param>
        /// <param name="newFile"></param>
        /// <returns></returns>
        private ReqIF WriteHeader(string file, bool newFile=true)
        {
        ...
        /// - XHTML
        /// </summary>
        private void CreateCoreDataTypes(ReqIF reqIf)
        {
        ...
        /// </summary>
        /// <param name="pkg"></param>
        private void WriteModule(EA.Package pkg)
        {
            var reqIfContent = _reqIf.CoreContent.SingleOrDefault();
            ...
            moduleSpecification.Identifier = pkg.PackageGUID;
            moduleSpecification.LastChange = DateTime.Now;
            moduleSpecification.LongName = pkg.Name;
        ...
        private void CreateAndAddAttributeDefinitionsToSpecType(SpecType specType, ReqIFContent reqIfContent)
        {
            ...
            attributeDefinitionReal.LastChange = DateTime.Now;
