...
namespace hoReverse.hoUtils.Diagrams {
    public class DiagramObjectStyle : DiagramGeneralStyle
    {
        ...
        public DiagramObjectStyle(EA.Repository rep, EA.DiagramObject diaObj, string type, string style,
            string property)
        ...
        public bool IsCompleteDiagram()
        {
            ...
            foreach (EA.DiagramLink l in dia.DiagramLinks)
            {
                if (l.IsHidden == true)
                {
                    ...
                    if ((sourceObject.ElementID == _diaObj.ElementID &&
                         sourceObject.ObjectType == _diaObj.ObjectType) ||
        ...
        public bool IsCompleteGlobal()
        {
            ...
            globalIds.AddRange(
                from Connector c in Rep.GetElementByID(_diaObj.ElementID).Connectors select c.ConnectorID);
